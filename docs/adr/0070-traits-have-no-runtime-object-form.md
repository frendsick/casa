...
Traits remain compile-time constraints with explicit implementation. Casa initially has no `dyn Trait`, existential trait value, vtable, object-safety rules, or dynamic trait-based destruction.
