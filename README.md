...
- **Traits** - explicit implementation and generic functions with trait requirements (`trait`, `Hashable`, `Display`)
...
| 8 | [Traits](docs/traits.md) | Trait definitions, explicit implementation, trait bounds, `Hashable` |
