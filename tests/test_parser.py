...
INTRINSIC_CASES = [
    ...
    ("load8", OpKind.LOAD8, Intrinsic.LOAD8),
    ("load16", OpKind.LOAD16, Intrinsic.LOAD16),
    ("load32", OpKind.LOAD32, Intrinsic.LOAD32),
    ("load64", OpKind.LOAD64, Intrinsic.LOAD64),
    ("store8", OpKind.STORE8, Intrinsic.STORE8),
    ("store16", OpKind.STORE16, Intrinsic.STORE16),
    ("store32", OpKind.STORE32, Intrinsic.STORE32),
    ("store64", OpKind.STORE64, Intrinsic.STORE64),
